...
"[project]/services/httpService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$httpService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/services/httpService.ts [app-ssr] (ecmascript)");
...
const userAuthStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])()((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$middleware$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["persist"])((set, get)=>({
        ...
        loginDoctor: async (email, password)=>{
            ...
            try {
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$httpService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["postWithoutAuth"])("/auth/doctor/login", {
                    email,
                    password
                });
        ...
        loginPatient: async (email, password)=>{
            ...
            try {
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$httpService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["postWithoutAuth"])("/auth/patient/login", {
                    email,
                    password
                });
                get().setUser(response.data.user, response.data.token);
        ...
        registerDoctor: async (data)=>{
            ...
            try {
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$httpService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["postWithoutAuth"])("/auth/doctor/register", data);
                get().setUser(response.data.user, response.data.token);
            } catch (error) {
                set({
                    error: error.message
        ...
        registerPatient: async (data)=>{
            ...
            try {
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$httpService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["postWithoutAuth"])("/auth/patient/register", data);
                get().setUser(response.data.user, response.data.token);
            } catch (error) {
                set({
                    error: error.message
        ...
        fetchProfile: async ()=>{
            ...
            try {
                ...
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$httpService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getWithAuth"])(endPoint);
                set({
                    user: {
                        ...user,
                        ...response.data
        ...
        updateProfile: async (data)=>{
            ...
            try {
                ...
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$httpService$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["putWithAuth"])(endPoint, data);
                set({
                    user: {
                        ...user,
                        ...response.data
...
//             const redirectPath = isAuthenticated && user?.type === "doctor" ? 
//             "/doctor/dashboad" : "/patient/dashboad";
...
//                 >
//                 </div>
//                 <div className='w-full h-full bg-gradient-to-br from-blue-600 via-blue-700
//                   to-blue-800 flex items-center justify-center'
//                 >
...
const layout = ({ children })=>{
    const { isAuthenticated, user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$store$2f$authStore$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["userAuthStore"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (isAuthenticated && user) {
            if (!user.isVerified) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["redirect"])(`/onboarding/${user.type}`);
            } else {
                if (user.type === 'doctor') {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["redirect"])('/doctor/dashboard');
                } else {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["redirect"])('/patient/dashboard');
                }
            }
        }
    }, [
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "w-full lg:w-1/2 flex items-center justify-center p-6 bg-white",
                children: children
            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "w-full h-full bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 flex items-center justify-center",
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: "Connecting patients with certified healthcare providers for quality medical consultations."
                                }, void 0, false, {
                                    fileName: "[project]/app/(auth)/layout.tsx",
                                    lineNumber: 105,
                                    columnNumber: 14
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ce5a906c._.js.map